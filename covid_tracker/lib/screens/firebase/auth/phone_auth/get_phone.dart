...
class PhoneAuthGetPhone extends StatefulWidget {
  ...
  final String logo = Assets.covid;
...
class _PhoneAuthGetPhoneState extends State<PhoneAuthGetPhone> {
        ...
        child: Stack(
          children: <Widget>[
            SingleChildScrollView(
              child: Center(child: _getBody(countriesProvider)),
            ),
  ...
  Widget _getColumnBody(CountryProvider countriesProvider) => Column(
        ...
        children: <Widget>[
          ...
          Padding(
            padding:
                EdgeInsets.only(top: _fixedPadding, left: _fixedPadding * 2),
          ...
          Padding(
              padding: EdgeInsets.only(
                  left: _fixedPadding * 2, right: _fixedPadding * 2),
          ...
          Padding(
            padding: EdgeInsets.only(top: 10.0, left: _fixedPadding * 2),
            child: SubTitle(text: 'Enter your phone'),
          ),
          //  PhoneNumber TextFormFields
          Padding(
            padding: EdgeInsets.only(
                left: _fixedPadding * 2,
                right: _fixedPadding * 2,
          ...
          Row(
            mainAxisSize: MainAxisSize.min,
            children: <Widget>[
              SizedBox(width: _fixedPadding * 2),
              Icon(Icons.info, color: DarkTheme.secondaryText, size: 25.0),
              SizedBox(width: 10.0),
              Expanded(
                child: RichText(
